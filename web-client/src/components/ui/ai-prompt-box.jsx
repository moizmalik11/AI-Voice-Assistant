...
const VoiceRecorder = ({
  ...
  }, [isRecording]); // Don't include time/onStart/onStop to avoid re-triggering
...
const CustomDivider = () => (
  <div className="relative h-6 w-[1.5px] mx-1">
    <div
      className="absolute inset-0 bg-gradient-to-t from-transparent via-white/40 to-transparent rounded-full"
      style={{
...
export const PromptInputBox = React.forwardRef((props, ref) => {
  ...
  const [isRecording, setIsRecording] = React.useState(isRecordingExt);
                ...
                <AnimatePresence>
                  {showSearch && (
                    <motion.span
                      ...
                      className="text-xs overflow-hidden whitespace-nowrap text-white flex-shrink-0"
                    >
                      Search
                    </motion.span>
                  )}
              ...
              >
                <div className="w-5 h-5 flex items-center justify-center flex-shrink-0">
                  <motion.div
                    ...
                    transition={{ type: "spring", stiffness: 260, damping: 25 }}
                  >
                    <FolderCode className={cn("w-4 h-4", showCanvas ? "text-white" : "text-inherit")} />
                  </motion.div>
                </div>
                <AnimatePresence>
                  {showCanvas && (
